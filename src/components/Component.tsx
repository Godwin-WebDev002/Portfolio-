...
const Component = () => {
  ...
  return (
    <div className="bg-white/80 w-[100%] my-5 mt-15 sm:mt-5 h-content pb-10 rounded-3xl border-2 border-black overflow-auto ">
      <div className="w-[100%] flex justify-end relative ">
        <nav className="bg-black w-[93.5%] sm:w-110 h-10 sm:rounded-bl-xl sm:relative fixed top-0 sm:right-0 z-20 rounded-b-2xl sm:rounded-b-none ">
